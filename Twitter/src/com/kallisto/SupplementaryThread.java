...
public class SupplementaryThread extends Thread {

    
    private static HashSet<String> brandNames;
    private MongoDB db;
    private WEKA weka;
    ...
    SupplementaryThread(Runnable runnable, MongoDB db) throws LangDetectException {
        super(runnable);
        this.db = db;
        this.weka = new WEKA();
...
//                    Logger.getLogger(StoringThread.class.getName()).log(Level.SEVERE, null, ex);
                    ...
                    Logger.getLogger(SupplementaryThread.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
    ...
    private String findMatchingBrand(String text) {
        ...
        for (int i = 0; i < split.length; i++) {
            if (brandNames.contains(split[i].toLowerCase())) {
                return split[i];
            }
        }
